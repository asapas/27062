...
Map<String, dynamic> environmentold = {
  ...
  "multiSiteConfigs": [
    {
      ...
      "serverConfig": {
        ...
        'blog': 'https://listing.matyhub.com',
        'consumerKey': 'ck_2bf1f061cc1edac25f84db3895095eb570734886',
        'consumerSecret': 'ck_2bf1f061cc1edac25f84db3895095eb570734886',
        'multiVendorType': 'dokan',

        /// remove to use as native screen

        'addListingUrl': 'https://listing.matyhub.com/add-listing'
      },
      "name": "matyhub Listing",
      "icon":
          "https://trello.com/1/cards/65192cacb5910345cae52ca5/attachments/65192cacb5910345cae52cca/download/listing.jpeg",
      "languageCode": "en",
      "currencyCode": "USD"
    },
    {
      ...
      "serverConfig": {
        ...
        'url': 'https://matyhub.com',
        'type': 'woo',
        'consumerKey': 'ck_e1ae3370f795a69e9b979ac3476b8449fe0d4db1',
        'consumerSecret': 'cs_0274e3b0e2651499e6426768821e13e831fcf557',

        /// Wordpress blog, it could be removed if using the same above url
        'blog': 'https://matyhub.com',
      },
      "name": "matyhub WooCommerce",
      "icon":
          "https://trello.com/1/cards/65192caf9f4b0466a4ff2023/attachments/65192caf9f4b0466a4ff204a/previews/65192cb09f4b0466a4ff209c/download/woo.jpeg.jpg",
      "languageCode": "en",
      "currencyCode": "USD"
    },
    {
      "configFolder": "mv_store",
      "serverConfig": {
        'type': 'wcfm',
        'url': 'https://vendor.matyhub.com',
        'consumerKey': 'ck_cf6b2a2966f2d908cc08ebaef1336b15f9a6697c',
        'consumerSecret': 'cs_9756800a6b17a6c76bcde454de61fd30ce389fad',
        'blog': 'https://vendor.matyhub.com',

        /// remove to use as native screen
        'forgetPassword':
            'https://vendor.matyhub.com/wp-login.php?action=lostpassword'
      },
      "name": "matyhub Multi Vendor",
      "icon":
          "https://trello.com/1/cards/65192cae8ff0731be35ed55a/attachments/65192cae8ff0731be35ed580/previews/65192cae8ff0731be35ed5a3/download/mv.jpeg.jpg",
      "languageCode": "en",
      "currencyCode": "USD"
    },
  ],
  ...
  "loginSetting": {
    ...
    "appleLoginSetting": {
      "iOSBundleId": "com.inspireui.mstore.flutter.max",
  ...
  "stripeConfig": {
    ...
    "merchantIdentifier": "merchant.com.inspireui.mstore.flutter.max",
  ...
  "expressPayConfig": {
    ...
    "merchantId": "merchant.com.inspireui.mstore.flutter.max",
    "production": false,
    'enabled': true
  },
